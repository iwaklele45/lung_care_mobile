...
class _CareFinderPageState extends State<CareFinderPage> {
  ...
  /// RS data from Kaggle dataset: Hospital Data in Indonesia (Kemenkes).
  /// Puskesmas addresses from Dinkes Surabaya.
  static const List<Facility> _allFacilities = [
    // ─── RUMAH SAKIT (Kaggle: Hospital Data in Indonesia) ───
    Facility(
      type: 'Rumah Sakit',
    ...
    Facility(
      ...
      address: 'Jl. Nginden Intan Barat, Surabaya',
      phone: '(031) 5924500',
      hours: 'Buka 24 Jam',
      hoursWeekday: '24 Jam',
      hoursWeekend: '24 Jam',
    ...
    Facility(
      type: 'Rumah Sakit',
      name: 'RS Primasatya Husada Citra',
